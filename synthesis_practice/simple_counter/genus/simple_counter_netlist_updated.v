...
// Generated on: Feb 23 2025 16:16:32 PST (Feb 24 2025 00:16:32 UTC)
...
module counter_8_bit(clk, rstn, count);
  ...
  wire clk, rstn;
  wire [7:0] count;
  wire UNCONNECTED, UNCONNECTED0, UNCONNECTED1, UNCONNECTED2, UNCONNECTED3, \count[0]_45 , n_0, n_2;
  wire n_3, n_4, n_5, n_6, n_7, n_8, n_9, n_10;
  wire n_14, n_15, n_16, n_17, n_20, n_24, n_25;
  SDFFR_X2 \count_reg[7] (.RN (rstn), .CK (clk), .D (n_0), .SE (n_20), .SI (count[7]), .Q (count[7]), .QN (n_0));
  DFFR_X2 \count_reg[6] (.RN (rstn), .CK (clk), .D (n_24), .Q (count[6]), .QN (UNCONNECTED));
  NAND2_X1 g187__5107(.A1 (n_16), .A2 (count[6]), .ZN (n_20));
  DFFR_X2 \count_reg[5] (.RN (rstn), .CK (clk), .D (n_17), .Q (count[5]), .QN (n_14));
  AOI21_X1 g189__6260(.A (n_16), .B1 (n_15), .B2 (n_14), .ZN (n_17));
  DFFR_X2 \count_reg[4] (.RN (rstn), .CK (clk), .D (n_25), .Q (count[4]), .QN (UNCONNECTED0));
  NOR2_X1 g192__4319(.A1 (n_15), .A2 (n_14), .ZN (n_16));
  NAND2_X1 g195__8428(.A1 (n_9), .A2 (count[4]), .ZN (n_15));
  DFFR_X2 \count_reg[3] (.RN (rstn), .CK (clk), .D (n_10), .Q (count[3]), .QN (n_7));
  AOI21_X1 g197__6783(.A (n_9), .B1 (n_8), .B2 (n_7), .ZN (n_10));
  NOR2_X1 g200__3680(.A1 (n_8), .A2 (n_7), .ZN (n_9));
  DFFR_X2 \count_reg[2] (.RN (rstn), .CK (clk), .D (n_6), .Q (count[2]), .QN (UNCONNECTED1));
  DFFR_X2 \count_reg[1] (.RN (rstn), .CK (clk), .D (n_5), .Q (count[1]), .QN (UNCONNECTED2));
  ...
  DFFR_X1 \count_reg[0] (.RN (rstn), .CK (clk), .D (\count[0]_45 ), .Q (UNCONNECTED3), .QN (\count[0]_45 ));
